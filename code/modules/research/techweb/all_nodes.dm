...
/datum/techweb_node/base
	...
	"rglass","plasteel","plastitanium","plasmaglass","plasmareinforcedglass","titaniumglass","plastitaniumglass","plumbing_rcd", "antivirus", "nanocarbon_glass", "durasteel", "duranium")
...
/datum/techweb_node/mech_tools
	...
	design_ids = list("mech_drill", "mech_mscanner", "mech_extinguisher", "mech_foam_extinguisher")
...
/datum/techweb_node/beam_weapons
	...
	design_ids = list("temp_gun", "xray_laser", "energy_naval")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
...
/datum/techweb_node/adv_naval_beam_weapons
	id = "adv_naval_beam_weapons"
	display_name = "Advanced Naval beam weaponry"
	description = "Various advanced beam weapons"
	prereq_ids = list("adv_beam_weapons")
	design_ids = list("energy_burst", "energy_phase")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
